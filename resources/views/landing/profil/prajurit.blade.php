@extends('layouts.app')
@section('title',"Prajurit - Lanal Biak")
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="page-title-wrapper">
                        <h1 class="page-title mb-10">PROFIL PRAJURIT BERPRESTASI</h1>
                    </div>
                    <div class="breadcrumb-menu">
                        <nav aria-label="Breadcrumbs" class="breadcrumb-trail breadcrumbs">
                            <ul class="trail-items">
                                ...
                                <li class="trail-item trail-end"><span>Prajurit Berprestasi</span></li>
                            </ul>
                        </nav>
                    </div>
                </div>
