...
<div class="card" id="card-admin" style="margin-right: 2%; width: 100%; size: 100px; font-size: 25px;">
   ...
   <div class="card-body">
      ...
      @endif
      <form method="POST" enctype="multipart/form-data" action="{{route('admin.header.aboutus.update', $viewData["data"]->id)}}" style="margin-right: 20px; font-size: 25px;">
         @csrf
         @method('put')
         ...
         <div class="form-group">
            <label for="image" class="form_label">Image <a href="{{url('storage/images/header/aboutus/'.$viewData["data"]->image)}}" target="__blank"><i class="fa fa-info-circle"></i></a></label>
            <input type="file" name="image2" class="form-control" />
         </div>
         <button type="submit" class="btn btn-success float-right ml-1">Submit</button>
         <a href="{{route('admin.header.aboutus.index')}}" class="btn btn-secondary float-right">Back</a>
      </form>
   </div>
</div>
@endsection
