...
<div class="content-header row">
    <div class="content-header-left col-md-12 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title mb-0">Data Tentang Satuan</h2>
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a class="btn btn-outline-primary" href="{{route('admin.header.aboutus.create')}}"><i class='feather icon-plus'></i> Tambah Data</a>
                        @endif
                    </div>
                                    ...
                                    <tbody>
                                        @foreach ($viewData["data"] as $value)
                                            <tr>
                                                <td>{{$value->id}}</td>
                                                <td>
                                                    <a href="{{url('storage/images/header/aboutus/'.$value->image)}}" target="__blank"><img src="{{url('storage/images/header/aboutus/'.$value->image)}}" class="img-thumbnail" alt="{{ $value->image }}" style="max-height: 50px;"></a>
                                                </td>
                                                ...
                                                <td>
                                                  <div class="btn-container">
                                                    ...
                                                    <a href="{{route('admin.header.aboutus.edit', $value->id)}}" class="btn btn-warning btn-sm">
                                                    ...
                                                    <form id="delete-form-{{$value->id}}" action="{{route('admin.header.aboutus.destroy', $value->id)}}" method="post">
                                                      @csrf
                                                      @method('delete')
                                                    </form>
